...
use App\Repository\JobFinitionRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: JobFinitionRepository::class)]
#[ORM\Table(name: 'JOB_FINITION')]
class JobFinition implements JobInterface
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(inversedBy: 'jobFinitions')]
